...
a. ***‘date of acquisition’*** means the date on which a specimen was taken from the wild, born in captivity or artificially propagated, or, if such date is unknown, the earliest provable date on which it was possessed by any person;
...
c. ***‘breeding stock’*** means all the animals in a breeding operation that were or are used for reproduction;
